...
- **Hybrid Pipeline Standard**: Agents formulate qualitative theses and parameter estimates (Phase 1), and then pass these parameters to deterministic engines (`valuation_model.py`, `return_engine.py`, `onboard_company.py`, `calculate_pricing.py`, `validate_thesis.py`) to compute mathematical outputs and verify schema integrity (Phase 2).
